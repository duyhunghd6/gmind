...
PROMPT=$(cat <<'EOF'
/project:ralph-loop stage1 for @docs/PRDs/core-gmind/PRD-04-WebUI-and-PM-Workspace.md , and note that the Stage 1 output for @docs/PRDs/core-gmind/PRD-04-WebUI-and-PM-Workspace.md must be written to ./docs/design/contracts/webui-and-pm-workspace . You can edit these subagents for Gemini extension (and Claude Code subagents / workflow) also. These stage1 result must coverages all these routes::: |
