---
name: api_ralph_dev
description: API Developer Agent for the API Ralph Loop. Triggered to write Go backend handlers, database queries, and migrations.
kind: local
model: inherit
max_turns: 20
tools:
...
<!-- beads-id: br-agent-api-ralph-dev -->
