---
name: api_ralph_qa
description: API Quality Assurance Agent for the API Ralph Loop. Triggered to write/run unit tests and static code verification.
kind: local
model: inherit
max_turns: 15
tools:
...
<!-- beads-id: br-agent-api-ralph-qa -->
