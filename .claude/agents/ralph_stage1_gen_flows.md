...
1. MUST run the reusable validator after writing Mermaid artifacts: `python3 .claude/skills/design-system-ralph-loop/scripts/validate_mermaid_markdown.py {contract_path}/flow.md`. It extracts fenced `mermaid` blocks from Markdown and validates them.
