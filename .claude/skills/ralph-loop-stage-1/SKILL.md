...
2. Dispatch `ralph_stage1_gen_flows` to create or update the Mermaid Logic Machine and derived `flow.mmd`, `storyboards.json`, `component-map.json`, and `prd-ds-conflicts.md`.
