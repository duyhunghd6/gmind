...
- Showcase static/mock data is mapped to Core WebUI Go REST API endpoints; browser direct access to FrankenSQLite, Zvec, local git, GitHub `gh`, FastCode, or shell remains forbidden. Owner: Stage 2 implementer.
