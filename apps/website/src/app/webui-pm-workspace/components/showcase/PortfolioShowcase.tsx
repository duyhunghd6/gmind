...
export function PortfolioShowcase({ state = "default", onAction }: { state?: string; onAction?: (e: string, target?: string) => void }) {
  return (
    <div aria-label="Portfolio View Screen">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          <div className="card" style={{ padding: "20px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
              ...
              <button className="btn-primary btn-sm" onClick={() => onAction && onAction("EVENT_REFRESH")}>+ Tạo Epic Mới</button>
            </div>
      ...
      {state === "error" && <ErrorBanner title="Không thể tải Portfolio" message="API Gateway timeout." onRetry={() => onAction && onAction("EVENT_REFRESH")} fullpage />}
