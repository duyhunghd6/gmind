...
export default function WebUIPMWorkspacePage() {
  ...
  useEffect(() => {
    const handleHashChange = () => {
      ...
      if (hash === "surface-dashboard") hash = "/";
      else if (hash === "surface-board") hash = "/board";
      else if (hash === "surface-tasks") hash = "/tasks";
      else if (hash === "surface-tasks-detail") hash = "/tasks/1";
      else if (hash === "surface-trace") hash = "/trace/1";
      else if (hash === "surface-docs") hash = "/docs";
      else if (hash === "surface-approval") hash = "/approval";
      else if (hash === "surface-search") hash = "/search";
      setActiveRoute(hash);
    };
