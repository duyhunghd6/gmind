            ...
            {selected && (
              <div className="ve-card" style={{ padding: "16px", alignSelf: "start" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                  <Link href="/design-system-old/knowledge-graph" style={{ fontSize: "0.75rem", color: "var(--accent-cyan)", textDecoration: "none" }}>🧠 View in Knowledge Graph →</Link>
                  {selected.beadsId && <Link href="/design-system-old/beads-traversal" style={{ fontSize: "0.75rem", color: "var(--accent-cyan)", textDecoration: "none" }}>🔗 Trace Beads ID →</Link>}
                  {(selected.type === "doc" || selected.type === "adr" || selected.type === "spike") && <Link href="/design-system-old/doc-viewer" style={{ fontSize: "0.75rem", color: "var(--accent-cyan)", textDecoration: "none" }}>📄 Open in Doc Viewer →</Link>}
                </div>
              </div>
            )}
          </div>
