...
export const diagram: DiagramEntry = {
  ...
  quiz: {
    ...
    options: [
      "Flamegraph là biểu đồ đo thân nhiệt phần cứng CPU theo chu kỳ. Các ô màu thể hiện Core nào đang cày ải quá sức để Developer mua tản nhiệt mới.",
      "Agentic LLM phân tích text form (stackcollapse) từ Flamegraph thành chuỗi Call-stack phân tầng. Từ đó chẩn đoán chính xác Bottleneck thay vì mò mẫm Performance.",
      "Biểu đồ Flamegraph là công cụ độc quyền của hệ thống Java Virtual Machine. Nên nó vô dụng hoàn toàn với NodeJS hay Python.",
      "LLM sử dụng trình đọc đồ họa tích hợp để soi từng Pixel và Vector Path trên file SVG, qua đó nội suy chính xác cấu trúc hàm bên trong."
    ],
    correctIndex: 1,
