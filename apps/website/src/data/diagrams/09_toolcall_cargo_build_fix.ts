...
export const diagram: DiagramEntry = {
  ...
  quiz: {
    ...
    options: [
      "Quy trình Waterfall Sequential. LLM đọc toàn bộ code một lần duy nhất, sửa tất cả lỗi rồi mới build ở bước cuối để tiết kiệm tối đa vòng lặp.",
      "Mô hình Self-Correction Agent dùng Compiler Error làm Ground Truth. Stack-trace lỗi được đưa lại vào Context để LLM tự hiểu sai lầm và lặp lại Code-Fix đến khi thành công.",
      "Hệ thống Test-Driven Development (TDD) truyền thống. LLM bắt buộc viết Unit Test trước rồi mới sửa code, việc build lỗi chỉ là phụ.",
      "Vòng lặp Static Analysis thông thường. LLM chỉ dùng tool quét qua AST chứ không hề thực thi lệnh dịch mã nguồn thực sự."
    ],
    correctIndex: 1,
