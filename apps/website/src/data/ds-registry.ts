...
export const SCREEN_ID_MAP: Record<string, string> = {
  ...
  "/terminal": "ds:screen:terminal-001",
  "/git-graph": "ds:screen:git-graph-001",
  "/board": "ds:screen:kanban-001",
  "/knowledge-graph": "ds:screen:knowledge-graph-001",
  "/approval": "ds:screen:approval-001",
  "/timeline": "ds:screen:timeline-001",
  "/components": "ds:screen:components-001",
  "/docs": "ds:screen:doc-viewer-001",
  "/search": "ds:screen:explorer-001",
  "/trace": "ds:screen:beads-traversal-001",
  "/storyboards": "ds:screen:storyboard-001",
};
